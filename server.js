const SUPABASE_URL = 'https://avkwuvnshxkhpxfgyrqy.supabase.co';
        ...
        async function fetchLeaderboard() {
            ...
            container.innerHTML = data.map(player => `
                <div class="bg-[#005fb8] flex items-center p-3 rounded-lg pixel-shadow border border-white/10">
                    ...
                    <div class="flex items-center bg-[#004a8f] px-3 py-2 rounded-md flex-shrink-0">
                        ...
                        <span class="text-white text-[9px] md:text-[10px]">${player.robux_count} ROBUX</span>
                    </div>
                </div>
            `).join('');
        }
